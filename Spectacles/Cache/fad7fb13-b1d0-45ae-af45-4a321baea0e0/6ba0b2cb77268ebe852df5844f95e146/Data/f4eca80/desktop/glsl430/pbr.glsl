...
//sampler sampler baseTexSmpSC 2:27
...
//sampler sampler z_hitIdAndBarycentricSmp 2:42
//sampler sampler z_rayDirectionsSmpSC 2:43
//texture texture2D baseTex 2:3:2:27
...
//texture texture2D sc_EnvmapDiffuse 2:7:2:31
//texture texture2D sc_EnvmapSpecular 2:8:2:32
//texture texture2D sc_OITAlpha0 2:9:2:33
//texture texture2D sc_OITAlpha1 2:10:2:33
//texture texture2D sc_OITDepthHigh0 2:11:2:33
//texture texture2D sc_OITDepthHigh1 2:12:2:33
//texture texture2D sc_OITDepthLow0 2:13:2:33
//texture texture2D sc_OITDepthLow1 2:14:2:33
//texture texture2D sc_OITFilteredDepthBoundsTexture 2:15:2:33
//texture texture2D sc_OITFrontDepthTexture 2:16:2:33
//texture texture2D sc_RayTracedAoTexture 2:17:2:34
//texture texture2D sc_RayTracedDiffIndTexture 2:18:2:35
//texture texture2D sc_RayTracedReflectionTexture 2:19:2:36
//texture texture2D sc_RayTracedShadowTexture 2:20:2:37
...
//texture utexture2D z_hitIdAndBarycentric 2:25:2:42
//texture texture2D z_rayDirections 2:26:2:43
//texture texture2DArray baseTexArrSC 2:44:2:27
//texture texture2DArray intensityTextureArrSC 2:45:2:28
//texture texture2DArray materialParamsTexArrSC 2:46:2:29
//texture texture2DArray normalTexArrSC 2:47:2:30
//texture texture2DArray sc_EnvmapDiffuseArrSC 2:48:2:31
//texture texture2DArray sc_EnvmapSpecularArrSC 2:49:2:32
//texture texture2DArray sc_RayTracedAoTextureArrSC 2:50:2:34
//texture texture2DArray sc_RayTracedDiffIndTextureArrSC 2:51:2:35
//texture texture2DArray sc_RayTracedReflectionTextureArrSC 2:52:2:36
//texture texture2DArray sc_RayTracedShadowTextureArrSC 2:53:2:37
//texture texture2DArray sc_ScreenTextureArrSC 2:54:2:39
...
#if (baseTexLayout==2)
{
l9_3=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_2,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTexArrSC);
}
#else
{
l9_3=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_2,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
...
{
l9_4=sc_SampleTextureBiasOrLevel(normalTexDims.xy,normalTexLayout,normalTexGetStereoViewIndex(),l9_2,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex),(int(SC_USE_UV_MIN_MAX_normalTex)!=0),normalTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0),normalTexBorderColor,0.0,normalTexArrSC);
}
#else
{
l9_4=sc_SampleTextureBiasOrLevel(normalTexDims.xy,normalTexLayout,normalTexGetStereoViewIndex(),l9_2,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex),(int(SC_USE_UV_MIN_MAX_normalTex)!=0),normalTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0),normalTexBorderColor,0.0,normalTex);
...
{
l9_5=sc_SampleTextureBiasOrLevel(materialParamsTexDims.xy,materialParamsTexLayout,materialParamsTexGetStereoViewIndex(),l9_2,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex),(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0),materialParamsTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0),materialParamsTexBorderColor,0.0,materialParamsTexArrSC);
}
#else
{
...
{
l9_6=mat3(l9_0,cross(l9_1,l9_0)*varTangent.w,l9_1)*((l9_4.xyz*1.9921875)-vec3(1.0)).xyz;
}
#else
{
l9_6=vec3(0.0);
...
#endif
float l9_7=clamp(l9_3.w,0.0,1.0);
...
{
uvec3 l9_8=uvec3(round((varPos-OriginNormalizationOffset)*OriginNormalizationScale));
...
{
l9_18=uint(clamp(l9_5.y,0.0,1.0)*1000.0);
}
...
#if (baseTexLayout==2)
{
l9_14=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_13,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTexArrSC);
}
#else
{
l9_14=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_13,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
...
#if (normalTexLayout==2)
{
l9_15=sc_SampleTextureBiasOrLevel(normalTexDims.xy,normalTexLayout,normalTexGetStereoViewIndex(),l9_13,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex),(int(SC_USE_UV_MIN_MAX_normalTex)!=0),normalTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0),normalTexBorderColor,0.0,normalTexArrSC);
}
#else
{
l9_15=sc_SampleTextureBiasOrLevel(normalTexDims.xy,normalTexLayout,normalTexGetStereoViewIndex(),l9_13,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex),(int(SC_USE_UV_MIN_MAX_normalTex)!=0),normalTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0),normalTexBorderColor,0.0,normalTex);
...
#if (!sc_ProjectiveShadowsCaster)
{
l9_17=mat3(l9_3,l9_1,l9_2)*((l9_15.xyz*1.9921875)-vec3(1.0)).xyz;
}
#else
{
l9_17=vec3(0.0);
...
#endif
float l9_18=clamp(l9_14.w,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
if (l9_18<alphaTestThreshold)
{
discard;
}
}
...
#if (ENABLE_STIPPLE_PATTERN_TEST)
{
if (l9_18<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
#endif
vec3 l9_19=max(l9_14.xyz,vec3(0.0));
vec4 l9_20;
#if (sc_ProjectiveShadowsCaster)
{
l9_20=vec4(l9_19,l9_18);
}
#else
{
l9_20=ngsCalculateLighting(l9_19,l9_18,l9_17,l9_4,l9_5,Port_Emissive_N006,clamp(l9_16.x,0.0,1.0),clamp(l9_16.y,0.0,1.0),clamp(vec3(l9_16.z),vec3(0.0),vec3(1.0)),Port_SpecularAO_N006);
}
#endif
vec4 l9_21=max(l9_20,vec4(0.0));
if (isProxyMode)
{
vec4 l9_22;
#if (sc_ProxyAlphaOne)
...
#endif
sc_writeFragData0(max(l9_22,vec4(0.0)));
return;
}
vec4 l9_24;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_26=clamp(l9_21.w*2.0,0.0,1.0);
}
#else
{
float l9_27;
...
{
l9_27=clamp(dot(l9_21.xyz,vec3(l9_21.w)),0.0,1.0);
}
#else
{
float l9_28;
...
#if (sc_BlendMode_Multiply)
{
l9_29=(1.0-dot(l9_21.xyz,vec3(0.33333001)))*l9_21.w;
}
#else
{
float l9_30;
...
{
l9_30=(1.0-clamp(dot(l9_21.xyz,vec3(1.0)),0.0,1.0))*l9_21.w;
}
#else
{
float l9_31;
#if (sc_BlendMode_ColoredGlass)
{
l9_31=clamp(dot(l9_21.xyz,vec3(1.0)),0.0,1.0)*l9_21.w;
}
#else
{
float l9_32;
#if (sc_BlendMode_Add)
{
l9_32=clamp(dot(l9_21.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_33;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_33=clamp(dot(l9_21.xyz,vec3(1.0)),0.0,1.0)*l9_21.w;
}
#else
{
float l9_34;
...
{
l9_34=dot(l9_21.xyz,vec3(0.33333001))*l9_21.w;
}
#else
{
float l9_35;
#if (sc_BlendMode_Min)
{
l9_35=1.0-clamp(dot(l9_21.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_36;
#if (sc_BlendMode_Max)
{
l9_36=clamp(dot(l9_21.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_36=1.0;
...
#endif
l9_24=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_21.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_25);
}
#else
{
vec4 l9_37;
...
{
vec3 l9_39=sc_GetFramebufferColor().xyz;
vec3 l9_40=mix(l9_39,definedBlend(l9_39,l9_21.xyz).xyz,vec3(l9_21.w));
...
{
float l9_43=l9_21.w;
l9_42=vec4(mix(vec3(1.0),l9_21.xyz,vec3(l9_43)),l9_43);
}
#else
{
vec4 l9_44;
...
#endif
l9_44=vec4(l9_21.xyz*l9_46,l9_46);
}
#else
{
l9_44=l9_21;
