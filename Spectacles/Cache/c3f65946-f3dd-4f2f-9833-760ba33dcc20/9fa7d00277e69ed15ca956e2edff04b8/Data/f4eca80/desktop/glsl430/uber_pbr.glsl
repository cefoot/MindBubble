...
#endif
l9_31=ssSRGB_to_Linear(l9_42)*reflectionIntensity;
}
#else
{
l9_31=vec3(0.0);
...
{
l9_54=pow(l9_53,rimExponent);
}
l9_45=vec3(0.0)+(ssSRGB_to_Linear(l9_47)*l9_54);
}
#else
{
l9_45=vec3(0.0);
...
#endif
float l9_59=clamp(l9_17,0.0,1.0);
...
#endif
if (dot(l9_8,l9_58)>=(-0.050000001))
{
uvec3 l9_60=uvec3(round((varPos-OriginNormalizationOffset)*OriginNormalizationScale));
position_and_mask=uvec4(l9_60.x,l9_60.y,l9_60.z,position_and_mask.w);
position_and_mask.w=uint(receiver_mask);
vec3 l9_61=abs(l9_58);
vec3 l9_62=l9_58/vec3(dot(l9_61,vec3(1.0)));
float l9_63=clamp(-l9_62.z,0.0,1.0);
float l9_64=l9_62.x;
float l9_65;
if (l9_64>=0.0)
{
...
uvec2 l9_69=uvec2(packHalf2x16(vec2(l9_66,0.0)),packHalf2x16(vec2(l9_67+l9_68,0.0)));
normal_and_more=uvec4(l9_69.x,l9_69.y,normal_and_more.z,normal_and_more.w);
...
{
l9_70=uint(clamp(l9_55,0.0,1.0)*1000.0);
}
normal_and_more.w=l9_70|uint((receiverId%32)<<int(10u));
}
else
{
...
#endif
l9_44=ssSRGB_to_Linear(l9_55)*reflectionIntensity;
}
#else
{
l9_44=vec3(0.0);
...
{
l9_67=pow(l9_66,rimExponent);
}
l9_58=vec3(0.0)+(ssSRGB_to_Linear(l9_60)*l9_67);
}
#else
{
l9_58=vec3(0.0);
...
#endif
vec3 l9_68=ssPow((l9_43+l9_44)+l9_58,vec3(0.45454547));
vec3 l9_69;
#if (NODE_38_DROPLIST_ITEM==3)
{
l9_69=tempGlobals.VertexColor.xyz;
}
#else
{
l9_69=vec3(1.0);
...
#if (ENABLE_MATERIAL_PARAM_TEX)
{
vec2 l9_73=N7_getUV(NODE_221_DROPLIST_ITEM);
vec4 l9_74;
#if (materialParamsTexLayout==2)
{
l9_74=sc_SampleTextureBiasOrLevel(materialParamsTexDims.xy,materialParamsTexLayout,materialParamsTexGetStereoViewIndex(),l9_73,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex),(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0),materialParamsTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0),materialParamsTexBorderColor,0.0,materialParamsTexArrSC);
}
#else
{
l9_74=sc_SampleTextureBiasOrLevel(materialParamsTexDims.xy,materialParamsTexLayout,materialParamsTexGetStereoViewIndex(),l9_73,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex),(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0),materialParamsTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0),materialParamsTexBorderColor,0.0,materialParamsTex);
...
#endif
l9_72=roughness*l9_74.y;
l9_71=l9_69*l9_74.z;
l9_70=metallic*l9_74.x;
}
#else
{
l9_72=roughness;
...
{
vec3 l9_76=mix(vec3(0.039999999),l9_29.xyz*l9_70,vec3(l9_70));
l9_75=mix(vec3(1.0),mix((l9_76*(1.0-specularAoDarkening))*l9_76,vec3(1.0),vec3(l9_71.x)),vec3(specularAoIntensity));
}
#else
{
l9_75=vec3(1.0);
...
#endif
float l9_79=clamp(l9_30,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
...
#else
{
l9_81=ngsCalculateLighting(l9_80,l9_79,l9_78,l9_10,l9_11,max(l9_68,vec3(0.0)),clamp(l9_70,0.0,1.0),clamp(l9_72,0.0,1.0),clamp(l9_71,vec3(0.0),vec3(1.0)),clamp(l9_77,vec3(0.0),vec3(1.0)));
}
#endif
vec4 l9_82=max(l9_81,vec4(0.0));
if (isProxyMode)
{
vec4 l9_83;
#if (sc_ProxyAlphaOne)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_87=clamp(l9_82.w*2.0,0.0,1.0);
}
#else
{
float l9_88;
...
{
l9_88=clamp(dot(l9_82.xyz,vec3(l9_82.w)),0.0,1.0);
}
#else
{
float l9_89;
...
#if (sc_BlendMode_Multiply)
{
l9_90=(1.0-dot(l9_82.xyz,vec3(0.33333001)))*l9_82.w;
}
#else
{
float l9_91;
...
{
l9_91=(1.0-clamp(dot(l9_82.xyz,vec3(1.0)),0.0,1.0))*l9_82.w;
}
#else
{
float l9_92;
#if (sc_BlendMode_ColoredGlass)
{
l9_92=clamp(dot(l9_82.xyz,vec3(1.0)),0.0,1.0)*l9_82.w;
}
#else
{
float l9_93;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_94=clamp(dot(l9_82.xyz,vec3(1.0)),0.0,1.0)*l9_82.w;
}
#else
{
float l9_95;
...
{
l9_95=dot(l9_82.xyz,vec3(0.33333001))*l9_82.w;
}
#else
{
float l9_96;
...
{
vec3 l9_100=sc_GetFramebufferColor().xyz;
vec3 l9_101=mix(l9_100,definedBlend(l9_100,l9_82.xyz).xyz,vec3(l9_82.w));
vec4 l9_102=vec4(l9_101.x,l9_101.y,l9_101.z,vec4(0.0).w);
l9_102.w=1.0;
l9_99=l9_102;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_104=l9_82.w;
l9_103=vec4(mix(vec3(1.0),l9_82.xyz,vec3(l9_104)),l9_104);
}
#else
{
vec4 l9_105;
...
{
float l9_106=l9_82.w;
float l9_107;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_107=clamp(l9_106,0.0,1.0);
}
#else
{
l9_107=l9_106;
...
#endif
l9_105=vec4(l9_82.xyz*l9_107,l9_107);
}
#else
{
l9_105=l9_82;
...
{
l9_110=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_110=vec4(0.0);
...
vec4 l9_112=outputMotionVectorsIfNeeded(varPos,max(l9_111,vec4(0.0)));
