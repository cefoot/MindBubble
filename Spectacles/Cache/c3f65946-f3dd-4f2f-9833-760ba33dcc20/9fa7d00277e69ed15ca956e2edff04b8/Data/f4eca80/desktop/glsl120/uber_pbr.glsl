...
#endif
l9_32=ssSRGB_to_Linear(l9_44)*reflectionIntensity;
}
#else
{
l9_32=vec3(0.0);
...
{
l9_56=pow(l9_55,rimExponent);
}
l9_47=vec3(0.0)+(ssSRGB_to_Linear(l9_49)*l9_56);
}
#else
{
l9_47=vec3(0.0);
...
#endif
vec3 l9_57=ssPow((l9_31+l9_32)+l9_47,vec3(0.45454547));
vec3 l9_58;
#if (NODE_38_DROPLIST_ITEM==3)
{
l9_58=tempGlobals.VertexColor.xyz;
}
#else
{
l9_58=vec3(1.0);
...
{
vec2 l9_62=N7_getUV(NODE_221_DROPLIST_ITEM);
int l9_63;
...
#endif
vec4 l9_64=sc_SampleTextureBiasOrLevel(materialParamsTexDims.xy,materialParamsTexLayout,l9_63,l9_62,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex),(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0),materialParamsTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0),materialParamsTexBorderColor,0.0,materialParamsTex);
l9_61=roughness*l9_64.y;
l9_60=l9_58*l9_64.z;
l9_59=metallic*l9_64.x;
}
#else
{
l9_61=roughness;
...
{
vec3 l9_66=mix(vec3(0.039999999),l9_16.xyz*l9_59,vec3(l9_59));
l9_65=mix(vec3(1.0),mix((l9_66*(1.0-specularAoDarkening))*l9_66,vec3(1.0),vec3(l9_60.x)),vec3(specularAoIntensity));
}
#else
{
l9_65=vec3(1.0);
...
#endif
float l9_69=clamp(l9_17,0.0,1.0);
...
#endif
vec3 l9_70=max(l9_16.xyz,vec3(0.0));
vec4 l9_71;
#if (sc_ProjectiveShadowsCaster)
{
l9_71=vec4(l9_70,l9_69);
}
#else
{
float l9_72=clamp(l9_59,0.0,1.0);
float l9_73=clamp(l9_61,0.0,1.0);
vec3 l9_74=clamp(l9_60,vec3(0.0),vec3(1.0));
vec3 l9_75=clamp(l9_67,vec3(0.0),vec3(1.0));
vec3 l9_76=ssSRGB_to_Linear(l9_70);
vec3 l9_77=normalize(l9_68);
vec3 l9_78=ssSRGB_to_Linear(max(l9_57,vec3(0.0)));
vec3 l9_79;
#if (sc_SSAOEnabled)
{
l9_79=evaluateSSAO(varPos);
}
#else
{
l9_79=l9_74;
...
#endif
vec3 l9_80=vec3(l9_72);
vec3 l9_81=mix(vec3(0.039999999),l9_76*l9_72,l9_80);
vec3 l9_82=mix(l9_76*(1.0-l9_72),vec3(0.0),l9_80);
SurfaceProperties l9_83=SurfaceProperties(l9_82,l9_69,l9_77,varPos,l9_6,l9_72,l9_73,l9_78,l9_79,l9_75,vec3(1.0),l9_81);
vec4 l9_84=vec4(1.0);
vec3 l9_85;
vec3 l9_86;
vec3 l9_87;
...
l9_93=vec3(0.0);
l9_92=vec3(0.0);
LightingComponents l9_99;
LightProperties l9_100;
SurfaceProperties l9_101;
vec3 l9_102;
int l9_103=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_103<sc_DirectionalLightsCount)
{
LightingComponents l9_104=accumulateLight(LightingComponents(l9_92,l9_93,l9_98,l9_97,l9_95,l9_94),LightProperties(sc_DirectionalLights[l9_103].direction,sc_DirectionalLights[l9_103].color.xyz,sc_DirectionalLights[l9_103].color.w*l9_84[(l9_96<3) ? l9_96 : 3]),l9_83,l9_6);
l9_98=l9_104.indirectDiffuse;
l9_97=l9_104.indirectSpecular;
l9_96++;
l9_95=l9_104.emitted;
l9_94=l9_104.transmitted;
l9_93=l9_104.directSpecular;
l9_92=l9_104.directDiffuse;
l9_103++;
continue;
}
else
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_121<sc_PointLightsCount)
{
vec3 l9_123=sc_PointLights[l9_121].position-varPos;
vec3 l9_124=normalize(l9_123);
float l9_125=l9_84[(l9_122<3) ? l9_122 : 3];
float l9_126=clamp((dot(l9_124,sc_PointLights[l9_121].direction)*sc_PointLights[l9_121].angleScale)+sc_PointLights[l9_121].angleOffset,0.0,1.0);
float l9_127=(sc_PointLights[l9_121].color.w*l9_125)*(l9_126*l9_126);
float l9_128;
if (sc_PointLights[l9_121].falloffEnabled)
{
l9_128=l9_127*computeDistanceAttenuation(length(l9_123),sc_PointLights[l9_121].falloffEndDistance);
}
else
{
l9_128=l9_127;
...
l9_114=l9_122+1;
LightingComponents l9_129=accumulateLight(LightingComponents(l9_108,l9_109,l9_113,l9_112,l9_111,l9_110),LightProperties(l9_124,sc_PointLights[l9_121].color.xyz,l9_128),l9_83,l9_6);
l9_115=l9_129.directDiffuse;
l9_116=l9_129.directSpecular;
l9_117=l9_129.indirectDiffuse;
l9_118=l9_129.indirectSpecular;
l9_119=l9_129.emitted;
l9_120=l9_129.transmitted;
l9_113=l9_117;
l9_112=l9_118;
l9_122=l9_114;
l9_111=l9_119;
...
#if (sc_ProjectiveShadowsReceiver)
{
vec2 l9_133=abs(varShadowTex-vec2(0.5));
vec4 l9_134=texture2D(sc_ShadowTexture,varShadowTex)*step(max(l9_133.x,l9_133.y),0.5);
l9_132=mix(vec3(1.0),mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_134.xyz,vec3(sc_ShadowColor.w)),vec3(l9_134.w*sc_ShadowDensity));
}
#else
{
l9_132=vec3(1.0);
...
#endif
l9_131=l9_105*l9_132;
l9_130=l9_106*l9_132;
}
#else
{
l9_131=l9_105;
...
{
vec2 l9_136=calcPanoramicTexCoordsFromDir(l9_77,sc_EnvmapRotation.y);
vec4 l9_137;
...
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_138=calcSeamlessPanoramicUvsForSampling(l9_136,sc_EnvmapSpecularSize.xy,5.0);
}
#else
{
l9_138=l9_136;
...
#endif
l9_137=sc_EnvmapSpecularSampleViewIndexBias(l9_138,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#else
{
vec4 l9_139;
...
{
vec2 l9_140=calcSeamlessPanoramicUvsForSampling(l9_136,sc_EnvmapDiffuseSize.xy,0.0);
int l9_141;
...
#endif
l9_139=sc_SampleView(sc_EnvmapDiffuseDims.xy,l9_140,sc_EnvmapDiffuseLayout,l9_141,-13.0,sc_EnvmapDiffuse);
}
#else
{
l9_139=sc_EnvmapSpecularSampleViewIndexBias(l9_136,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#endif
l9_137=l9_139;
}
#endif
l9_135=(l9_137.xyz*(1.0/l9_137.w))*sc_EnvmapExposure;
}
#else
{
vec3 l9_142;
...
float l9_145=l9_143.y;
float l9_146=l9_143.z;
l9_142=(((((((sc_Sh[8]*0.42904299)*((l9_144*l9_144)-(l9_145*l9_145)))+((sc_Sh[6]*0.74312502)*(l9_146*l9_146)))+(sc_Sh[0]*0.88622701))-(sc_Sh[6]*0.24770799))+((((sc_Sh[4]*(l9_144*l9_145))+(sc_Sh[7]*(l9_144*l9_146)))+(sc_Sh[5]*(l9_145*l9_146)))*0.85808599))+((((sc_Sh[3]*l9_144)+(sc_Sh[1]*l9_145))+(sc_Sh[2]*l9_146))*1.0233279))*sc_ShIntensity;
}
#else
{
l9_142=vec3(0.0);
...
{
l9_148=l9_135+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_149=l9_135;
l9_149.x=l9_135.x+(1e-06*sc_AmbientLights[0].color.x);
l9_148=l9_149;
}
#endif
l9_147=l9_148;
...
{
l9_151=l9_147+(sc_AmbientLights[1].color*sc_AmbientLights[1].intensity);
}
#else
{
vec3 l9_152=l9_147;
l9_152.x=l9_147.x+(1e-06*sc_AmbientLights[1].color.x);
l9_151=l9_152;
}
#endif
l9_150=l9_151;
...
{
l9_154=l9_150+(sc_AmbientLights[2].color*sc_AmbientLights[2].intensity);
}
#else
{
vec3 l9_155=l9_150;
l9_155.x=l9_150.x+(1e-06*sc_AmbientLights[2].color.x);
l9_154=l9_155;
}
#endif
l9_153=l9_154;
...
{
vec3 l9_157;
l9_157=sc_LightEstimationData.ambientLight;
vec3 l9_158;
int l9_159=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_159<sc_LightEstimationSGCount)
{
float l9_160=dot(sc_LightEstimationData.sg[l9_159].axis,l9_77);
float l9_161=exp(-sc_LightEstimationData.sg[l9_159].sharpness);
float l9_162=l9_161*l9_161;
float l9_163=1.0/sc_LightEstimationData.sg[l9_159].sharpness;
float l9_164=(1.0+(2.0*l9_162))-l9_163;
float l9_165=sqrt(1.0-l9_164);
float l9_166=0.36000001*l9_160;
float l9_167=(1.0/(4.0*0.36000001))*l9_165;
float l9_168=l9_166+l9_167;
float l9_169;
if (step(abs(l9_166),l9_167)>0.5)
{
l9_169=(l9_168*l9_168)/l9_165;
}
else
{
l9_169=clamp(l9_160,0.0,1.0);
}
l9_158=l9_157+((((sc_LightEstimationData.sg[l9_159].color/vec3(sc_LightEstimationData.sg[l9_159].sharpness))*6.2831855)*((l9_164*l9_169)+(((l9_161-l9_162)*l9_163)-l9_162)))/vec3(3.1415927));
l9_157=l9_158;
l9_159++;
continue;
}
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_171=clamp(pow(l9_73,0.66666669),0.0,1.0)*5.0;
vec2 l9_172=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_77,reflect(-l9_6,l9_77),l9_73),sc_EnvmapRotation.y);
vec4 l9_173;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
float l9_174=floor(l9_171);
float l9_175=ceil(l9_171);
l9_173=mix(sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_172,sc_EnvmapSpecularSize.xy,l9_174),sc_EnvmapSpecularGetStereoViewIndex(),l9_174),sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_172,sc_EnvmapSpecularSize.xy,l9_175),sc_EnvmapSpecularGetStereoViewIndex(),l9_175),vec4(l9_171-l9_174));
}
#else
{
l9_173=sc_EnvmapSpecularSampleViewIndexLevel(l9_172,sc_EnvmapSpecularGetStereoViewIndex(),l9_171);
}
#endif
l9_170=vec3(0.0)+((((l9_173.xyz*(1.0/l9_173.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_83,abs(dot(l9_77,l9_6))));
}
#else
{
l9_170=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_177=clamp(l9_73*l9_73,0.0099999998,1.0);
vec3 l9_178;
l9_178=sc_LightEstimationData.ambientLight*l9_81;
int l9_179=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_179<sc_LightEstimationSGCount)
{
float l9_180=l9_177*l9_177;
vec3 l9_181=reflect(-l9_6,l9_77);
float l9_182=dot(l9_77,l9_6);
float l9_183=(2.0/l9_180)/(4.0*max(l9_182,9.9999997e-05));
float l9_184=length((l9_181*l9_183)+(sc_LightEstimationData.sg[l9_179].axis*sc_LightEstimationData.sg[l9_179].sharpness));
float l9_185=clamp(dot(l9_77,l9_181),0.0,1.0);
float l9_186=clamp(l9_182,0.0,1.0);
float l9_187=1.0-l9_180;
l9_178+=((((((((vec3(1.0/(3.1415927*l9_180))*exp((l9_184-l9_183)-sc_LightEstimationData.sg[l9_179].sharpness))*sc_LightEstimationData.sg[l9_179].color)*6.2831855)*(1.0-exp((-2.0)*l9_184)))/vec3(l9_184))*((1.0/(l9_185+sqrt(l9_180+((l9_187*l9_185)*l9_185))))*(1.0/(l9_186+sqrt(l9_180+((l9_187*l9_186)*l9_186))))))*(l9_81+((vec3(1.0)-l9_81)*pow(1.0-clamp(dot(l9_181,normalize(l9_181+l9_6)),0.0,1.0),5.0))))*l9_185);
l9_179++;
continue;
}
else
...
l9_191=vec3(0.0);
l9_190=vec3(0.0);
l9_189=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_82,vec3(l9_69));
l9_188=1.0;
}
#else
{
...
#endif
vec3 l9_193=l9_190*l9_79;
vec3 l9_194=l9_191+l9_193;
vec3 l9_195=l9_82*l9_194;
vec3 l9_196=l9_176*l9_75;
vec3 l9_197=l9_130+l9_196;
vec3 l9_198;
if (l9_192)
{
l9_198=l9_195*srgbToLinear(l9_188);
}
else
{
l9_198=l9_195;
}
vec3 l9_199=l9_198+l9_197;
vec3 l9_200=(l9_199+l9_78)+l9_189;
float l9_201=l9_200.x;
vec4 l9_202=vec4(l9_201,l9_200.yz,l9_188);
vec4 l9_203;
#if (sc_IsEditor)
{
vec4 l9_204=l9_202;
l9_204.x=l9_201+((l9_79.x*l9_75.x)*9.9999997e-06);
l9_203=l9_204;
}
#else
{
...
{
vec3 l9_206=l9_203.xyz*1.8;
vec3 l9_207=(l9_203.xyz*(l9_206+vec3(1.4)))/((l9_203.xyz*(l9_206+vec3(0.5)))+vec3(1.5));
l9_205=vec4(l9_207.x,l9_207.y,l9_207.z,l9_203.w);
}
#else
{
l9_205=l9_203;
...
#endif
vec3 l9_208=vec3(linearToSrgb(l9_205.x),linearToSrgb(l9_205.y),linearToSrgb(l9_205.z));
l9_71=vec4(l9_208.x,l9_208.y,l9_208.z,l9_205.w);
}
#endif
vec4 l9_209=max(l9_71,vec4(0.0));
vec4 l9_210;
#if (sc_ProjectiveShadowsCaster)
{
float l9_211;
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_212=clamp(l9_209.w*2.0,0.0,1.0);
}
#else
{
float l9_213;
...
{
l9_213=clamp(dot(l9_209.xyz,vec3(l9_209.w)),0.0,1.0);
}
#else
{
float l9_214;
...
#if (sc_BlendMode_Multiply)
{
l9_215=(1.0-dot(l9_209.xyz,vec3(0.33333001)))*l9_209.w;
}
#else
{
float l9_216;
...
{
l9_216=(1.0-clamp(dot(l9_209.xyz,vec3(1.0)),0.0,1.0))*l9_209.w;
}
#else
{
float l9_217;
#if (sc_BlendMode_ColoredGlass)
{
l9_217=clamp(dot(l9_209.xyz,vec3(1.0)),0.0,1.0)*l9_209.w;
}
#else
{
float l9_218;
#if (sc_BlendMode_Add)
{
l9_218=clamp(dot(l9_209.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_219;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_219=clamp(dot(l9_209.xyz,vec3(1.0)),0.0,1.0)*l9_209.w;
}
#else
{
float l9_220;
...
{
l9_220=dot(l9_209.xyz,vec3(0.33333001))*l9_209.w;
}
#else
{
float l9_221;
#if (sc_BlendMode_Min)
{
l9_221=1.0-clamp(dot(l9_209.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_222;
#if (sc_BlendMode_Max)
{
l9_222=clamp(dot(l9_209.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_222=1.0;
...
#endif
l9_210=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_209.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_211);
}
#else
{
vec4 l9_223;
...
{
vec3 l9_225=sc_GetFramebufferColor().xyz;
vec3 l9_226=mix(l9_225,definedBlend(l9_225,l9_209.xyz).xyz,vec3(l9_209.w));
vec4 l9_227=vec4(l9_226.x,l9_226.y,l9_226.z,vec4(0.0).w);
l9_227.w=1.0;
l9_224=l9_227;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_229=l9_209.w;
l9_228=vec4(mix(vec3(1.0),l9_209.xyz,vec3(l9_229)),l9_229);
}
#else
{
vec4 l9_230;
...
{
float l9_231=l9_209.w;
float l9_232;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_232=clamp(l9_231,0.0,1.0);
}
#else
{
l9_232=l9_231;
...
#endif
l9_230=vec4(l9_209.xyz*l9_232,l9_232);
}
#else
{
l9_230=l9_209;
...
{
l9_235=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_235=vec4(0.0);
...
vec4 l9_237=outputMotionVectorsIfNeeded(varPos,max(l9_236,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_239-0.0039215689)),min(1.0,l9_239+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_240=sc_ScreenCoordsGlobalToView(l9_5);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_240).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_241=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_240).xy);
float l9_242=packValue(l9_241);
int l9_249=int(l9_238.w*255.0);
float l9_250=packValue(l9_249);
sc_writeFragData0(vec4(packValue(l9_241),packValue(l9_241),packValue(l9_241),packValue(l9_241)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_253=sc_ScreenCoordsGlobalToView(l9_5);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_253).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_258==0)
{
l9_261=texture2D(sc_OITAlpha0,l9_253);
l9_260=texture2D(sc_OITDepthLow0,l9_253);
l9_259=texture2D(sc_OITDepthHigh0,l9_253);
}
else
{
l9_261=vec4(0.0);
...
if (l9_258==1)
{
l9_264=texture2D(sc_OITAlpha1,l9_253);
l9_263=texture2D(sc_OITDepthLow1,l9_253);
l9_262=texture2D(sc_OITDepthHigh1,l9_253);
}
else
{
l9_264=l9_261;
...
vec4 l9_279=texture2D(sc_OITFilteredDepthBoundsTexture,l9_253);
