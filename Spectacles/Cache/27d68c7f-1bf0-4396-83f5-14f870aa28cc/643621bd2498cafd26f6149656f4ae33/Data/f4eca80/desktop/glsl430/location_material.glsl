...
//sampler sampler sc_RayTracedAoTextureSmpSC 2:28
//sampler sampler sc_RayTracedDiffIndTextureSmpSC 2:29
//sampler sampler sc_RayTracedReflectionTextureSmpSC 2:30
//sampler sampler sc_RayTracedShadowTextureSmpSC 2:31
//sampler sampler sc_SSAOTextureSmpSC 2:32
//sampler sampler sc_ScreenTextureSmpSC 2:33
//sampler sampler sc_ShadowTextureSmpSC 2:34
//sampler sampler z_hitIdAndBarycentricSmp 2:36
//sampler sampler z_rayDirectionsSmpSC 2:37
//texture texture2D intensityTexture 2:3:2:24
//texture texture2D sc_EnvmapDiffuse 2:4:2:25
//texture texture2D sc_EnvmapSpecular 2:5:2:26
//texture texture2D sc_OITAlpha0 2:6:2:27
//texture texture2D sc_OITAlpha1 2:7:2:27
//texture texture2D sc_OITDepthHigh0 2:8:2:27
//texture texture2D sc_OITDepthHigh1 2:9:2:27
//texture texture2D sc_OITDepthLow0 2:10:2:27
//texture texture2D sc_OITDepthLow1 2:11:2:27
//texture texture2D sc_OITFilteredDepthBoundsTexture 2:12:2:27
//texture texture2D sc_OITFrontDepthTexture 2:13:2:27
//texture texture2D sc_RayTracedAoTexture 2:14:2:28
//texture texture2D sc_RayTracedDiffIndTexture 2:15:2:29
//texture texture2D sc_RayTracedReflectionTexture 2:16:2:30
//texture texture2D sc_RayTracedShadowTexture 2:17:2:31
//texture texture2D sc_SSAOTexture 2:18:2:32
//texture texture2D sc_ScreenTexture 2:19:2:33
//texture texture2D sc_ShadowTexture 2:20:2:34
//texture utexture2D z_hitIdAndBarycentric 2:22:2:36
//texture texture2D z_rayDirections 2:23:2:37
//texture texture2DArray intensityTextureArrSC 2:38:2:24
//texture texture2DArray sc_EnvmapDiffuseArrSC 2:39:2:25
//texture texture2DArray sc_EnvmapSpecularArrSC 2:40:2:26
//texture texture2DArray sc_RayTracedAoTextureArrSC 2:41:2:28
//texture texture2DArray sc_RayTracedDiffIndTextureArrSC 2:42:2:29
//texture texture2DArray sc_RayTracedReflectionTextureArrSC 2:43:2:30
//texture texture2DArray sc_RayTracedShadowTextureArrSC 2:44:2:31
//texture texture2DArray sc_ScreenTextureArrSC 2:45:2:33
...
#endif
if (dot(normalize(sc_Camera.position-varPos),l9_0)>=(-0.050000001))
{
uvec3 l9_1=uvec3(round((varPos-OriginNormalizationOffset)*OriginNormalizationScale));
position_and_mask=uvec4(l9_1.x,l9_1.y,l9_1.z,position_and_mask.w);
position_and_mask.w=uint(receiver_mask);
vec3 l9_2=abs(l9_0);
vec3 l9_3=l9_0/vec3(dot(l9_2,vec3(1.0)));
float l9_4=clamp(-l9_3.z,0.0,1.0);
float l9_5=l9_3.x;
float l9_6;
if (l9_5>=0.0)
{
...
uvec2 l9_10=uvec2(packHalf2x16(vec2(l9_7,0.0)),packHalf2x16(vec2(l9_8+l9_9,0.0)));
normal_and_more=uvec4(l9_10.x,l9_10.y,normal_and_more.z,normal_and_more.w);
...
{
l9_11=uint(clamp(Port_Roughness_N006,0.0,1.0)*1000.0);
}
normal_and_more.w=l9_11|uint((receiverId%32)<<int(10u));
}
else
{
...
vec4 l9_5;
if ((float(l9_3.w>Port_Input1_N012)*1.0)!=0.0)
{
l9_5=l9_3;
}
else
...
#if (sc_ProjectiveShadowsCaster)
{
l9_7=vec4(Port_Albedo_N006,Port_Opacity_N006);
}
#else
{
l9_7=ngsCalculateLighting(Port_Albedo_N006,Port_Opacity_N006,l9_6,l9_1,l9_2,Port_Emissive_N006,Port_Metallic_N006,Port_Roughness_N006,Port_AO_N006,Port_SpecularAO_N006);
}
#endif
l9_5=max(l9_7,vec4(0.0));
}
if (isProxyMode)
{
vec4 l9_8;
...
{
l9_13=clamp(dot(l9_5.xyz,vec3(l9_5.w)),0.0,1.0);
}
#else
{
float l9_14;
...
#if (sc_BlendMode_Multiply)
{
l9_15=(1.0-dot(l9_5.xyz,vec3(0.33333001)))*l9_5.w;
}
#else
{
float l9_16;
...
{
l9_16=(1.0-clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0))*l9_5.w;
}
#else
{
float l9_17;
#if (sc_BlendMode_ColoredGlass)
{
l9_17=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0)*l9_5.w;
}
#else
{
float l9_18;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_19=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0)*l9_5.w;
}
#else
{
float l9_20;
...
{
l9_20=dot(l9_5.xyz,vec3(0.33333001))*l9_5.w;
}
#else
{
float l9_21;
#if (sc_BlendMode_Min)
{
l9_21=1.0-clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_22;
#if (sc_BlendMode_Max)
{
l9_22=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_22=1.0;
...
#endif
l9_10=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_5.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_11);
}
#else
{
vec4 l9_23;
...
{
vec3 l9_25=sc_GetFramebufferColor().xyz;
vec3 l9_26=mix(l9_25,definedBlend(l9_25,l9_5.xyz).xyz,vec3(l9_5.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_28=vec4(mix(vec3(1.0),l9_5.xyz,vec3(l9_5.w)),l9_5.w);
}
#else
{
vec4 l9_29;
...
#endif
l9_29=vec4(l9_5.xyz*l9_30,l9_30);
}
#else
{
l9_29=l9_5;
