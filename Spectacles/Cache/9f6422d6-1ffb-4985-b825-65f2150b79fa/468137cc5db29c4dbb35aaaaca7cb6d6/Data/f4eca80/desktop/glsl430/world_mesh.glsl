...
uniform float Port_Multiplier_N022;
uniform float Port_Import_N040;
uniform vec3 Port_Import_N038;
uniform vec2 Port_Scale_N013;
uniform vec2 Port_Scale_N015;
uniform vec2 Port_Scale_N020;
...
{
uint l9_0=min(primitiveId,uint(lray_triangles_last))*6u;
uint l9_1=l9_0&4294967292u;
uint l9_2=l9_1/4u;
uint l9_3=layoutIndices_obj._Triangles[l9_2];
uint l9_4=l9_2+1u;
uint l9_5=layoutIndices_obj._Triangles[l9_4];
...
ivec3 l9_19=get_indices(l9_1.y);
vec3 l9_20;
if (has_animated_pn)
{
l9_20=interp_float3_animated(l9_7,l9_19,0);
}
else
{
int l9_21=(l9_19.x*emitter_stride)+proxy_offset_position;
int l9_22=(l9_19.y*emitter_stride)+proxy_offset_position;
int l9_23=(l9_19.z*emitter_stride)+proxy_offset_position;
vec3 l9_24;
if (proxy_format_position==5)
{
l9_24=((vec3(layoutVertices_obj._Vertices[l9_21],layoutVertices_obj._Vertices[l9_21+1],layoutVertices_obj._Vertices[l9_21+2])*l9_6)+(vec3(layoutVertices_obj._Vertices[l9_22],layoutVertices_obj._Vertices[l9_22+1],layoutVertices_obj._Vertices[l9_22+2])*l9_4))+(vec3(layoutVertices_obj._Vertices[l9_23],layoutVertices_obj._Vertices[l9_23+1],layoutVertices_obj._Vertices[l9_23+2])*l9_5);
}
else
{
vec3 l9_25;
...
{
l9_25=((vec3(unpackHalf2x16(floatBitsToUint(layoutVertices_obj._Vertices[l9_21])),unpackHalf2x16(floatBitsToUint(layoutVertices_obj._Vertices[l9_21+1])).x)*l9_6)+(vec3(unpackHalf2x16(floatBitsToUint(layoutVertices_obj._Vertices[l9_22])),unpackHalf2x16(floatBitsToUint(layoutVertices_obj._Vertices[l9_22+1])).x)*l9_4))+(vec3(unpackHalf2x16(floatBitsToUint(layoutVertices_obj._Vertices[l9_23])),unpackHalf2x16(floatBitsToUint(layoutVertices_obj._Vertices[l9_23+1])).x)*l9_5);
}
else
{
l9_25=vec3(1.0,0.0,0.0);
}
l9_24=l9_25;
}
l9_20=(sc_ModelMatrix*vec4(l9_24,1.0)).xyz;
}
vec3 l9_26;
...
if (has_animated_pn)
{
l9_27=interp_float3_animated(l9_7,l9_19,3);
}
else
{
int l9_28=(l9_19.x*emitter_stride)+proxy_offset_normal;
int l9_29=(l9_19.y*emitter_stride)+proxy_offset_normal;
int l9_30=(l9_19.z*emitter_stride)+proxy_offset_normal;
vec3 l9_31;
...
l9_27=normalize(sc_NormalMatrix*l9_31);
}
l9_26=l9_27;
}
else
{
l9_26=vec3(1.0,0.0,0.0);
}
vec4 l9_33;
if ((!has_animated_pn)&&(proxy_offset_tangent>0))
{
int l9_34=(l9_19.x*emitter_stride)+proxy_offset_tangent;
int l9_35=(l9_19.y*emitter_stride)+proxy_offset_tangent;
int l9_36=(l9_19.z*emitter_stride)+proxy_offset_tangent;
vec4 l9_37;
if (proxy_format_tangent==5)
{
l9_37=((vec4(layoutVertices_obj._Vertices[l9_34],layoutVertices_obj._Vertices[l9_34+1],layoutVertices_obj._Vertices[l9_34+2],layoutVertices_obj._Vertices[l9_34+3])*l9_6)+(vec4(layoutVertices_obj._Vertices[l9_35],layoutVertices_obj._Vertices[l9_35+1],layoutVertices_obj._Vertices[l9_35+2],layoutVertices_obj._Vertices[l9_35+3])*l9_4))+(vec4(layoutVertices_obj._Vertices[l9_36],layoutVertices_obj._Vertices[l9_36+1],layoutVertices_obj._Vertices[l9_36+2],layoutVertices_obj._Vertices[l9_36+3])*l9_5);
}
else
{
vec4 l9_38;
...
{
l9_38=((vec4(unpackHalf2x16(floatBitsToUint(layoutVertices_obj._Vertices[l9_34])),unpackHalf2x16(floatBitsToUint(layoutVertices_obj._Vertices[l9_34+1])))*l9_6)+(vec4(unpackHalf2x16(floatBitsToUint(layoutVertices_obj._Vertices[l9_35])),unpackHalf2x16(floatBitsToUint(layoutVertices_obj._Vertices[l9_35+1])))*l9_4))+(vec4(unpackHalf2x16(floatBitsToUint(layoutVertices_obj._Vertices[l9_36])),unpackHalf2x16(floatBitsToUint(layoutVertices_obj._Vertices[l9_36+1])))*l9_5);
}
else
{
vec4 l9_39;
...
{
l9_39=((fetch_unorm_byte4(l9_34)*l9_6)+(fetch_unorm_byte4(l9_35)*l9_4))+(fetch_unorm_byte4(l9_36)*l9_5);
}
else
{
l9_39=vec4(1.0,0.0,0.0,0.0);
}
l9_38=l9_39;
}
l9_37=l9_38;
}
l9_33=vec4(normalize(sc_NormalMatrix*l9_37.xyz),l9_37.w);
}
else
{
l9_33=vec4(1.0,0.0,0.0,1.0);
}
vec4 l9_40;
if (proxy_format_color>0)
{
int l9_41=(l9_19.x*emitter_stride)+proxy_offset_color;
int l9_42=(l9_19.y*emitter_stride)+proxy_offset_color;
int l9_43=(l9_19.z*emitter_stride)+proxy_offset_color;
vec4 l9_44;
...
vec2 l9_47=vec2(dot(l9_7,vec3(ivec3(1)-(l9_19%ivec3(2)))),0.0);
vec2 l9_48;
if (proxy_format_texture0>0)
{
int l9_49=(l9_19.x*emitter_stride)+proxy_offset_texture0;
int l9_50=(l9_19.y*emitter_stride)+proxy_offset_texture0;
int l9_51=(l9_19.z*emitter_stride)+proxy_offset_texture0;
vec2 l9_52;
if (proxy_format_texture0==5)
{
l9_52=((vec2(layoutVertices_obj._Vertices[l9_49],layoutVertices_obj._Vertices[l9_49+1])*l9_6)+(vec2(layoutVertices_obj._Vertices[l9_50],layoutVertices_obj._Vertices[l9_50+1])*l9_4))+(vec2(layoutVertices_obj._Vertices[l9_51],layoutVertices_obj._Vertices[l9_51+1])*l9_5);
}
else
{
vec2 l9_53;
...
{
l9_53=((unpackHalf2x16(floatBitsToUint(layoutVertices_obj._Vertices[l9_49]))*l9_6)+(unpackHalf2x16(floatBitsToUint(layoutVertices_obj._Vertices[l9_50]))*l9_4))+(unpackHalf2x16(floatBitsToUint(layoutVertices_obj._Vertices[l9_51]))*l9_5);
}
else
{
l9_53=vec2(1.0,0.0);
...
{
int l9_55=(l9_19.x*emitter_stride)+proxy_offset_texture1;
int l9_56=(l9_19.y*emitter_stride)+proxy_offset_texture1;
int l9_57=(l9_19.z*emitter_stride)+proxy_offset_texture1;
vec2 l9_58;
if (proxy_format_texture1==5)
{
l9_58=((vec2(layoutVertices_obj._Vertices[l9_55],layoutVertices_obj._Vertices[l9_55+1])*l9_6)+(vec2(layoutVertices_obj._Vertices[l9_56],layoutVertices_obj._Vertices[l9_56+1])*l9_4))+(vec2(layoutVertices_obj._Vertices[l9_57],layoutVertices_obj._Vertices[l9_57+1])*l9_5);
}
else
{
vec2 l9_59;
...
{
l9_59=((unpackHalf2x16(floatBitsToUint(layoutVertices_obj._Vertices[l9_55]))*l9_6)+(unpackHalf2x16(floatBitsToUint(layoutVertices_obj._Vertices[l9_56]))*l9_4))+(unpackHalf2x16(floatBitsToUint(layoutVertices_obj._Vertices[l9_57]))*l9_5);
}
else
{
l9_59=vec2(1.0,0.0);
...
{
int l9_61=(l9_19.x*emitter_stride)+proxy_offset_texture2;
int l9_62=(l9_19.y*emitter_stride)+proxy_offset_texture2;
int l9_63=(l9_19.z*emitter_stride)+proxy_offset_texture2;
vec2 l9_64;
if (proxy_format_texture2==5)
{
l9_64=((vec2(layoutVertices_obj._Vertices[l9_61],layoutVertices_obj._Vertices[l9_61+1])*l9_6)+(vec2(layoutVertices_obj._Vertices[l9_62],layoutVertices_obj._Vertices[l9_62+1])*l9_4))+(vec2(layoutVertices_obj._Vertices[l9_63],layoutVertices_obj._Vertices[l9_63+1])*l9_5);
}
else
{
vec2 l9_65;
...
{
l9_65=((unpackHalf2x16(floatBitsToUint(layoutVertices_obj._Vertices[l9_61]))*l9_6)+(unpackHalf2x16(floatBitsToUint(layoutVertices_obj._Vertices[l9_62]))*l9_4))+(unpackHalf2x16(floatBitsToUint(layoutVertices_obj._Vertices[l9_63]))*l9_5);
}
else
{
l9_65=vec2(1.0,0.0);
...
{
int l9_67=(l9_19.x*emitter_stride)+proxy_offset_texture3;
int l9_68=(l9_19.y*emitter_stride)+proxy_offset_texture3;
int l9_69=(l9_19.z*emitter_stride)+proxy_offset_texture3;
vec2 l9_70;
if (proxy_format_texture3==5)
{
l9_70=((vec2(layoutVertices_obj._Vertices[l9_67],layoutVertices_obj._Vertices[l9_67+1])*l9_6)+(vec2(layoutVertices_obj._Vertices[l9_68],layoutVertices_obj._Vertices[l9_68+1])*l9_4))+(vec2(layoutVertices_obj._Vertices[l9_69],layoutVertices_obj._Vertices[l9_69+1])*l9_5);
}
else
{
vec2 l9_71;
...
{
l9_71=((unpackHalf2x16(floatBitsToUint(layoutVertices_obj._Vertices[l9_67]))*l9_6)+(unpackHalf2x16(floatBitsToUint(layoutVertices_obj._Vertices[l9_68]))*l9_4))+(unpackHalf2x16(floatBitsToUint(layoutVertices_obj._Vertices[l9_69]))*l9_5);
}
else
{
l9_71=vec2(1.0,0.0);
...
return RayHitPayload(-normalize(vec3(l9_18.x,l9_18.y,l9_13.z)),l9_20,l9_26,l9_33,l9_40,l9_48,l9_54,l9_60,l9_66,l9_2);
}
vec3 CalculateProxyFaceNormal()
{
uvec4 l9_0=texelFetch(z_hitIdAndBarycentric,ivec2(gl_FragCoord.xy),0);
if (l9_0.x!=uint(instance_id))
{
return vec3(0.0,1.0,0.0);
}
ivec3 l9_1=get_indices(l9_0.y);
vec3 l9_2;
vec3 l9_3;
vec3 l9_4;
if (has_animated_pn)
...
int l9_6=l9_1.y*6;
int l9_7=l9_1.z*6;
l9_4=vec3(layoutVerticesPN_obj._VerticesPN[l9_7],layoutVerticesPN_obj._VerticesPN[l9_7+1],layoutVerticesPN_obj._VerticesPN[l9_7+2]);
l9_3=vec3(layoutVerticesPN_obj._VerticesPN[l9_5],layoutVerticesPN_obj._VerticesPN[l9_5+1],layoutVerticesPN_obj._VerticesPN[l9_5+2]);
l9_2=vec3(layoutVerticesPN_obj._VerticesPN[l9_6],layoutVerticesPN_obj._VerticesPN[l9_6+1],layoutVerticesPN_obj._VerticesPN[l9_6+2]);
}
else
{
vec3 l9_8;
...
if (proxy_format_position==5)
{
int l9_11=(l9_1.x*emitter_stride)+proxy_offset_position;
int l9_12=(l9_1.y*emitter_stride)+proxy_offset_position;
int l9_13=(l9_1.z*emitter_stride)+proxy_offset_position;
l9_10=vec3(layoutVertices_obj._Vertices[l9_13],layoutVertices_obj._Vertices[l9_13+1],layoutVertices_obj._Vertices[l9_13+2]);
l9_9=vec3(layoutVertices_obj._Vertices[l9_11],layoutVertices_obj._Vertices[l9_11+1],layoutVertices_obj._Vertices[l9_11+2]);
l9_8=vec3(layoutVertices_obj._Vertices[l9_12],layoutVertices_obj._Vertices[l9_12+1],layoutVertices_obj._Vertices[l9_12+2]);
}
else
{
bool l9_14=proxy_format_position==6;
if (!l9_14)
{
return vec3(0.0,1.0,0.0);
}
int l9_15=(l9_1.x*emitter_stride)+proxy_offset_position;
int l9_16=(l9_1.y*emitter_stride)+proxy_offset_position;
int l9_17=(l9_1.z*emitter_stride)+proxy_offset_position;
l9_10=vec3(unpackHalf2x16(floatBitsToUint(layoutVertices_obj._Vertices[l9_17])),unpackHalf2x16(floatBitsToUint(layoutVertices_obj._Vertices[l9_17+1])).x);
l9_9=vec3(unpackHalf2x16(floatBitsToUint(layoutVertices_obj._Vertices[l9_15])),unpackHalf2x16(floatBitsToUint(layoutVertices_obj._Vertices[l9_15+1])).x);
l9_8=vec3(unpackHalf2x16(floatBitsToUint(layoutVertices_obj._Vertices[l9_16])),unpackHalf2x16(floatBitsToUint(layoutVertices_obj._Vertices[l9_16+1])).x);
}
l9_4=l9_10;
l9_3=l9_9;
l9_2=l9_8;
...
if (isProxyMode)
{
l9_3=CalculateProxyFaceNormal();
}
else
{
vec3 l9_4=cross(vec3(dFdx(l9_1.x),dFdx(l9_1.y),dFdx(l9_1.z)),vec3(dFdy(l9_1.x),dFdy(l9_1.y),dFdy(l9_1.z)));
l9_3=l9_4/vec3(length(l9_4));
}
vec3 l9_5=l9_3+vec3(1.0);
vec3 l9_6=l9_5/vec3(Port_Input1_N017);
vec3 l9_7=normalize(sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()][0].xyz);
float l9_8=l9_0*Port_Multiplier_N022;
float l9_9=radians(l9_8);
float l9_10=cos(l9_9);
vec3 l9_11=normalize(sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()][1].xyz);
vec3 l9_12;
if (isProxyMode)
{
l9_12=CalculateProxyFaceNormal();
}
else
{
vec3 l9_13=cross(vec3(dFdx(l9_1.x),dFdx(l9_1.y),dFdx(l9_1.z)),vec3(dFdy(l9_1.x),dFdy(l9_1.y),dFdy(l9_1.z)));
l9_12=l9_13/vec3(length(l9_13));
}
float l9_14=l9_6.x;
vec3 l9_15=l9_12+(((vec3(floor(fract(sin(dot(floor(vec2(l9_14,l9_6.y)*Port_Scale_N013),vec2(0.98979998,0.72329998)))*437.58545)*10000.0)*9.9999997e-05,floor(fract(sin(dot(floor(vec2(l9_6.y,l9_14)*Port_Scale_N015),vec2(0.98979998,0.72329998)))*437.58545)*10000.0)*9.9999997e-05,floor(fract(sin(dot(floor(vec2(l9_14,l9_6.z)*Port_Scale_N020),vec2(0.98979998,0.72329998)))*437.58545)*10000.0)*9.9999997e-05)*vec3(Port_Input1_N000))-vec3(1.0))*vec3(Port_Input1_N029));
...
float l9_19=abs(dot(((l9_7*vec3((l9_10-l9_9)*dot(l9_7,l9_11)))+(vec3(l9_10)*l9_11))+(vec3(sin(l9_9))*cross(l9_7,l9_11)),l9_18));
float l9_20;
if (l9_19<=0.0)
{
l9_20=0.0;
...
{
l9_20=pow(l9_19,Port_Input1_N003);
}
vec3 l9_21;
if (isProxyMode)
{
l9_21=CalculateProxyFaceNormal();
}
else
{
vec3 l9_22=cross(vec3(dFdx(l9_1.x),dFdx(l9_1.y),dFdx(l9_1.z)),vec3(dFdy(l9_1.x),dFdy(l9_1.y),dFdy(l9_1.z)));
l9_21=l9_22/vec3(length(l9_22));
}
float l9_23=dot(normalize(sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()][1].xyz),l9_21);
...
{
l9_25=pow(l9_24,Port_Input1_N056);
}
float l9_26=l9_20+l9_25;
float l9_27=l9_26/Port_Input1_N055;
vec3 l9_28=l9_6+((vec4(l9_27)*Port_Value_N023)/vec4(Port_Input1_N010)).xyz;
float l9_29=distance(sc_Camera.position,l9_1);
float l9_30=clamp(max(Port_Input0_N062-(clamp((l9_29/Port_Input1_N059)+0.001,Port_Input1_N061+0.001,Port_Input2_N061+0.001)-0.001),min(l9_27,Port_Input1_N019))+0.001,Port_Input1_N049+0.001,Port_Input2_N049+0.001)-0.001;
vec4 l9_31=vec4(l9_28.x,l9_28.y,l9_28.z,vec4(0.0).w);
l9_31.w=l9_30;
