...
float l9_1=dFdx(varPos.x);
float l9_2=dFdx(varPos.y);
float l9_3=dFdx(varPos.z);
float l9_4=dFdy(varPos.x);
float l9_5=dFdy(varPos.y);
float l9_6=dFdy(varPos.z);
vec3 l9_7=cross(vec3(l9_1,l9_2,l9_3),vec3(l9_4,l9_5,l9_6));
vec3 l9_8=((l9_7/vec3(length(l9_7)))+vec3(1.0))/vec3(Port_Input1_N017);
vec3 l9_9=normalize(sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()][0].xyz);
float l9_10=l9_0*Port_Multiplier_N022;
float l9_11=radians(l9_10);
float l9_12=cos(l9_11);
vec3 l9_13=normalize(sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()][1].xyz);
float l9_14=dFdx(varPos.x);
float l9_15=dFdx(varPos.y);
float l9_16=dFdx(varPos.z);
float l9_17=dFdy(varPos.x);
float l9_18=dFdy(varPos.y);
float l9_19=dFdy(varPos.z);
vec3 l9_20=cross(vec3(l9_14,l9_15,l9_16),vec3(l9_17,l9_18,l9_19));
float l9_21=l9_8.x;
vec3 l9_22=(l9_20/vec3(length(l9_20)))+(((vec3(floor(fract(sin(dot(floor(vec2(l9_21,l9_8.y)*Port_Scale_N013),vec2(0.98979998,0.72329998)))*437.58545)*10000.0)*9.9999997e-05,floor(fract(sin(dot(floor(vec2(l9_8.y,l9_21)*Port_Scale_N015),vec2(0.98979998,0.72329998)))*437.58545)*10000.0)*9.9999997e-05,floor(fract(sin(dot(floor(vec2(l9_21,l9_8.z)*Port_Scale_N020),vec2(0.98979998,0.72329998)))*437.58545)*10000.0)*9.9999997e-05)*vec3(Port_Input1_N000))-vec3(1.0))*vec3(Port_Input1_N029));
float l9_23=dot(l9_22,l9_22);
float l9_24;
if (l9_23>0.0)
{
l9_24=1.0/sqrt(l9_23);
}
else
{
l9_24=0.0;
}
vec3 l9_25=l9_22*l9_24;
float l9_26=abs(dot(((l9_9*vec3((l9_12-l9_11)*dot(l9_9,l9_13)))+(vec3(l9_12)*l9_13))+(vec3(sin(l9_11))*cross(l9_9,l9_13)),l9_25));
float l9_27;
if (l9_26<=0.0)
{
l9_27=0.0;
...
{
l9_27=pow(l9_26,Port_Input1_N003);
}
float l9_28=dFdx(varPos.x);
float l9_29=dFdx(varPos.y);
float l9_30=dFdx(varPos.z);
float l9_31=dFdy(varPos.x);
float l9_32=dFdy(varPos.y);
float l9_33=dFdy(varPos.z);
vec3 l9_34=cross(vec3(l9_28,l9_29,l9_30),vec3(l9_31,l9_32,l9_33));
float l9_35=abs(dot(normalize(sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()][1].xyz),l9_34/vec3(length(l9_34))));
float l9_36;
if (l9_35<=0.0)
{
l9_36=0.0;
...
{
l9_36=pow(l9_35,Port_Input1_N056);
}
float l9_37=l9_27+l9_36;
float l9_38=l9_37/Port_Input1_N055;
vec3 l9_39=l9_8+((vec4(l9_38)*Port_Value_N023)/vec4(Port_Input1_N010)).xyz;
float l9_40=clamp(max(Port_Input0_N062-(clamp((distance(sc_Camera.position,varPos)/Port_Input1_N059)+0.001,Port_Input1_N061+0.001,Port_Input2_N061+0.001)-0.001),min(l9_38,Port_Input1_N019))+0.001,Port_Input1_N049+0.001,Port_Input2_N049+0.001)-0.001;
vec4 l9_41=vec4(l9_39.x,l9_39.y,l9_39.z,vec4(0.0).w);
l9_41.w=l9_40;
...
{
l9_45=clamp(dot(l9_41.xyz,vec3(l9_40)),0.0,1.0);
}
#else
{
float l9_46;
...
{
l9_47=(1.0-dot(l9_41.xyz,vec3(0.33333001)))*l9_40;
}
#else
{
float l9_48;
...
{
l9_48=(1.0-clamp(dot(l9_41.xyz,vec3(1.0)),0.0,1.0))*l9_40;
}
#else
{
float l9_49;
...
{
l9_49=clamp(dot(l9_41.xyz,vec3(1.0)),0.0,1.0)*l9_40;
}
#else
{
float l9_50;
#if (sc_BlendMode_Add)
{
l9_50=clamp(dot(l9_41.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_51;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_51=clamp(dot(l9_41.xyz,vec3(1.0)),0.0,1.0)*l9_40;
}
#else
{
float l9_52;
...
{
l9_52=dot(l9_41.xyz,vec3(0.33333001))*l9_40;
}
#else
{
float l9_53;
#if (sc_BlendMode_Min)
{
l9_53=1.0-clamp(dot(l9_41.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_54;
#if (sc_BlendMode_Max)
{
l9_54=clamp(dot(l9_41.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_54=1.0;
...
#endif
l9_42=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_41.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_43);
}
#else
{
vec4 l9_55;
...
#if (sc_FramebufferFetch)
{
vec4 l9_58=sc_readFragData0_Platform();
vec4 l9_59;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_60=l9_58;
l9_60.x=l9_58.x+_sc_framebufferFetchMarker;
l9_59=l9_60;
}
#else
{
...
#endif
l9_57=sc_SampleView(sc_ScreenTextureDims.xy,l9_61,sc_ScreenTextureLayout,l9_62,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_63;
...
{
vec4 l9_64=l9_57;
l9_64.x=l9_57.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_63=l9_64;
}
#else
{
...
#endif
vec3 l9_65=mix(l9_63.xyz,definedBlend(l9_63.xyz,l9_41.xyz).xyz,vec3(l9_40));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_67=vec4(mix(vec3(1.0),l9_41.xyz,vec3(l9_40)),l9_40);
}
#else
{
vec4 l9_68;
...
#endif
l9_68=vec4(l9_41.xyz*l9_69,l9_69);
}
#else
{
l9_68=l9_41;
...
#endif
int l9_78=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_77).xy);
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_90).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_95==0)
{
l9_98=texture2D(sc_OITAlpha0,l9_90);
l9_97=texture2D(sc_OITDepthLow0,l9_90);
l9_96=texture2D(sc_OITDepthHigh0,l9_90);
}
else
{
l9_98=vec4(0.0);
...
if (l9_95==1)
{
l9_101=texture2D(sc_OITAlpha1,l9_90);
l9_100=texture2D(sc_OITDepthLow1,l9_90);
l9_99=texture2D(sc_OITDepthHigh1,l9_90);
}
else
{
l9_101=l9_98;
...
vec4 l9_116=texture2D(sc_OITFilteredDepthBoundsTexture,l9_90);
